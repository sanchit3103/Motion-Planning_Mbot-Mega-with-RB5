...
class MegaPiController:
    ...
    def format(self, fr, bl, br, fl):
        if self.verbose:
            print("Manual Manuvering: ")
        self.setFourMotors(-fr, bl, -br, fl)

    def manuver(self, v_x, v_y, v_th):
        fr, bl, br, fl = 0,0,0,0
        self.format(fr, bl, br, fl)
